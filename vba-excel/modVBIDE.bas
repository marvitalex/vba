...
'https://github.com/areed1192/sigma_coding_youtube/blob/master/vba/vba-advanced/visual-basic-editor/visual-basic-editor.vb
...
Set VBComp = VBProj.VBComponents.Item("modGitHub")
